...
describe Hyhull::Solr::Document::DublinCore do
  ...
  describe(:contributors) do
    it "will return an array of advisors and sponsors with the role set within the field" do
      expect(test_document_instance.contributors).to include("Briston, R. J. (Supervisor)", "University of Qatar (Sponsor)")
    end
  end

  describe(:extent) do
    it "will return the file size of the main resource asset" do
      expect(test_document_instance.extent).to eq("21 MB")
    end
  end
