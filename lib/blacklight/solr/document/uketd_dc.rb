...
module Blacklight::Solr::Document::UketdDc
  def self.extended(document)
    # Register our exportable formats
    Blacklight::Solr::Document::UketdDc.register_export_formats( document )
  end
  ...
  def dc_field_names
    [:contributor, :coverage, :creator, :date, :format, :identifier, :language, :publisher, :relation, :rights, :source, :subject, :title, :type]
  end
