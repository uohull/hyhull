...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name('creator_organisation_name', :symbol), :label => 'Creator (Organisation)',:limit => 10
    ...
    config.add_facet_field solr_name('person_affiliation', :facetable), :label => 'Affiliation', :limit => 10
    ...
    config.add_index_field solr_name('creator_organisation_name', :symbol, type: :string), :label => 'Creator'  
    ...
    config.add_sort_field 'score desc, sortable_date_dtsi desc, title_ssort asc', :label => 'relevance'
    config.add_sort_field 'sortable_date_dtsi desc, title_ssort asc', :label => 'year'
    config.add_sort_field 'creator_name_ssort asc, title_ssort asc', :label => 'author'
    config.add_sort_field 'title_ssort asc, sortable_date_dtsi desc', :label => 'title'
