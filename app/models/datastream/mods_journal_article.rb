class Datastream::ModsJournalArticle < ActiveFedora::OmDatastream
  ...
  set_terminology do |t|
    ...
    t.originInfo {
      t.free_to_read_start_date(
        path: "dateOther",
        attributes: { type: "free_to_read_start_date", encoding: "w3cdtf" } 
      )
      t.free_to_read_end_date(
        path: "dateOther",
    ...
    t.depositor_note(path: "note", attributes: { type: "depositorNote" } )
