...
class Book < ActiveFedora::Base
  ...
  # Addtional fields that the Book CModel makes use of...
   has_attributes  :related_item_publication_date, :related_item_publisher, :related_item_issuance, :related_item_place, :series_title, :related_item_physical_extent, :related_item_form, datastream: :descMetadata, 
       multiple: false
